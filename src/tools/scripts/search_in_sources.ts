...
export const search_in_sources = defineTool<Args, { totalHits: number; hits: Hit[] }>({
  name: 'search_in_sources',
  description: 'Alias of search_in_scripts. M3 RDP version differentiates by including dynamically-evaluated sources too.',
  schema,
